...
export function HeaderBar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-[58px] items-center gap-2.5 border-b border-border bg-background/80 px-4 backdrop-blur-[10px] md:px-6">
      <div className="flex min-w-0 items-center gap-2.5">
        ...
        />
        <span className="truncate text-[15px] font-extrabold text-foreground">{companyName}</span>
      </div>
