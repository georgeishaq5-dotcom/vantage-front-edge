...
import { ThemeModeControl } from "@/components/ThemeProvider";
import { Users, Plug, PhoneCall, ShieldCheck, ChevronRight, SunMoon } from "lucide-react";
...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Manage billing, your team, and integrations for Vantage FSM.",
      },
...
function SettingsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-5 md:px-8 md:py-8">
      <PageHeader
        title="Settings"
        description="Manage billing, your team, integrations, and trade presets."
      />
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Choose a light or dark theme, or match your device automatically.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 md:mt-6 grid grid-cols-1 gap-6">
            ...
            <div className="rounded-xl border border-border bg-card p-3 md:p-6 shadow-sm">
              ...
              <div className="mt-5 flex items-center justify-between border-t border-border pt-5">
                <p className="text-sm text-muted-foreground">
                  Manage your crew from the My Team workspace.
                </p>
            ...
            <div className="rounded-xl border border-border bg-card p-3 md:p-6 shadow-sm">
              ...
              <div className="mt-5 space-y-3 border-t border-border pt-5">
                ...
                <p className="text-xs text-muted-foreground">
                  Connect a Twilio Voice API token so Van can transcribe inbound phone leads and
                  turn calls into bookable jobs.
                </p>
