...
function Kicker({ index, label }: { index: string; label: string }) {
  return (
    <div className="flex items-center gap-4">
      ...
      <span className="text-[11px] font-bold uppercase tracking-[0.32em] text-[var(--sig)]">{label}</span>
    </div>
  );
}
...
function Bullets({ items }: { items: string[] }) {
  return (
    <ul className="mt-6 flex flex-col gap-3.5">
      {items.map((item) => (
        <li key={item} className="flex items-start gap-3.5 text-sm leading-[1.6] text-[oklch(0.85_0.01_257)]">
...
function GridFeature({ num, eyebrow, title, body, bullets, visual }: {
  num: string;
  eyebrow: string;
  title: string;
  body: string;
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(165deg, oklch(0.155 0.022 262), oklch(0.108 0.02 263))" }}
    >
      <span className="home-feat-bar" />
      <div className="flex items-center justify-between border-b border-[oklch(1_0_0/8%)] px-5 py-3.5">
        <Kicker index={num} label={eyebrow} />
        <span className="text-[10px] font-extrabold tracking-[0.28em] text-[oklch(0.46_0.02_257)]">FT-{num}</span>
      </div>
    ...
    <>
      ...
      <div className="absolute inset-0 flex flex-col justify-center gap-2 px-7">
        <div className="flex items-center gap-3">
          <span className="w-[52px] text-[10px] font-bold tracking-[0.08em] text-[oklch(0.5_0.02_257)]">2:00 PM</span>
        ...
        <div className="flex items-stretch gap-3">
          ...
          <div className="home-lm-slot relative min-h-[54px] flex-1 border border-[oklch(1_0_0/10%)]">
            <div className="home-lm-drop flex items-center gap-[11px] px-3 py-[9px]">
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-[oklch(0.95_0.006_247)]">Crew A — assigned in one tap</p>
                <p className="mt-[2px] text-[10.5px] text-[oklch(0.55_0.02_257)]">Confirmation texted to customer</p>
              </div>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <span className="w-[52px] text-[10px] font-bold tracking-[0.08em] text-[oklch(0.5_0.02_257)]">4:00 PM</span>
          <span className="block h-[30px] flex-1 border border-dashed border-[oklch(1_0_0/10%)]" />
        </div>
      </div>
    </>
...
function EditorialFeature({ reverse, num, eyebrow, title, body, bullets, tag, visual }: {
  reverse?: boolean;
  num: string;
  eyebrow: string;
  title: string;
    ...
    >
      ...
      <main>
        ...
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-9 pb-[110px] pt-[150px]">
          ...
          <div className="pointer-events-none absolute left-1/2 top-[44%] aspect-square w-[min(82vw,780px)] -translate-x-1/2 -translate-y-1/2">
            ...
            <div
              ...
              style={{
                background: "conic-gradient(color-mix(in oklch, var(--sig) 26%, transparent), transparent 58deg)",
                animation: "home-lm-radar 9s linear infinite",
              }}
            />
            <div className="absolute left-1/2 top-1/2 h-[86%] w-[86%]" style={{ animation: "home-lm-spin 26s linear infinite" }}>
          ...
          <div className="relative z-[2] flex max-w-[1100px] flex-col items-center text-center">
            ...
            <GlitchReveal variant="soft" delay={260}>
              <p className="mt-[30px] max-w-[720px] text-balance text-[clamp(15px,1.6vw,19px)] font-normal uppercase leading-[1.7] tracking-[0.14em] text-[oklch(0.78_0.015_257)]">
                It finds the work, books it, quotes it, and closes it — while you're still on a job site.
              </p>
            </GlitchReveal>
            ...
            <GlitchReveal variant="soft" delay={440}>
              <p className="mt-[22px] text-xs font-medium tracking-wide text-[oklch(0.52_0.02_257)]">
                Live in minutes. No card required — Vantage starts finding work before you've paid a cent.
              </p>
            </GlitchReveal>
          </div>

          <div className="absolute bottom-[34px] left-9 flex items-center gap-4">
            <span className="text-[11px] font-extrabold tracking-[0.24em] text-[var(--sig)]">FT</span>
            <span className="block h-px w-11 bg-[oklch(1_0_0/25%)]" />
            <span className="text-[11px] font-bold tracking-[0.24em] text-[oklch(0.45_0.02_257)]">06</span>
          </div>
          <div className="absolute bottom-[34px] right-9 flex items-center gap-3">
            <span className="text-[10px] font-bold uppercase tracking-[0.34em] text-[oklch(0.45_0.02_257)]">Scroll</span>
            <span
        ...
        <section className="relative overflow-hidden border-t border-[oklch(1_0_0/8%)] bg-[oklch(0.113_0.02_263)] px-9 py-[130px]">
          <div
            className="pointer-events-none absolute inset-0"
            style={{ background: "radial-gradient(44% 40% at 84% 30%, oklch(0.62 0.22 256 / 6%), transparent)" }}
          />
          <div className="relative mx-auto flex max-w-[1280px] flex-wrap items-center gap-[72px]">
            <div className="min-w-[min(100%,420px)] flex-[1.25_1_420px]">
              <GlitchReveal variant="soft">
                <div className="flex items-center gap-4">
                  <span className="block h-0.5 w-[26px] bg-[var(--sig)]" />
                  <span className="text-[11px] font-extrabold uppercase tracking-[0.32em] text-[var(--sig)]">One platform</span>
                </div>
              </GlitchReveal>
              <GlitchReveal variant="text" delay={120}>
                <h2
                ...
                >
                  One system that finds the work, wins it, schedules it, and collects — while you stay on the tools.
                </h2>
              </GlitchReveal>
            </div>
            <GlitchReveal variant="soft" delay={200} className="flex min-w-[min(100%,360px)] flex-[1_1_360px] justify-center">
              <div className="relative aspect-square w-full max-w-[380px]">
                <div
                  className="pointer-events-none absolute inset-0"
                  style={{ background: "radial-gradient(circle at 50% 50%, oklch(0.72 0.16 158 / 10%), transparent 62%)" }}
                />
        ...
        <section className="px-9 py-[120px]">
          <div className="mx-auto flex max-w-[1280px] flex-col gap-[110px]">
            ...
            <GlitchReveal variant="soft">
              <div className="flex flex-wrap items-center justify-between gap-6 border border-[oklch(1_0_0/9%)] bg-[oklch(0.15_0.022_262/55%)] px-6 py-[30px] sm:px-11">
                ...
                <div className="flex flex-wrap items-center gap-[18px]">
                  <span className="text-[11px] font-medium tracking-wide text-[oklch(0.52_0.02_257)]">No card required.</span>
            ...
            <div className="grid gap-[18px]" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 460px), 1fr))" }}>
              <GlitchReveal variant="soft">
                <GridFeature
                  num="03"
                  eyebrow="Operations"
          ...
          <div className="mx-auto max-w-[1280px]">
            <GlitchReveal variant="soft">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <span className="block h-0.5 w-[26px] bg-[var(--sig)]" />
                  <span className="text-[11px] font-extrabold uppercase tracking-[0.32em] text-[var(--sig)]">Field reports</span>
                </div>
              ...
              <div className="grid gap-[18px]" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 300px), 1fr))" }}>
                {SOCIAL_PROOF.map((card) => (
                  <div
                    ...
                    style={{ background: "linear-gradient(165deg, oklch(0.15 0.022 262), oklch(0.108 0.02 263))" }}
                  >
                    <span className="home-feat-bar" />
